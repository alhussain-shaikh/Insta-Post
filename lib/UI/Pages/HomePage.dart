            ...
            children: <Widget>[
              Row(
                ...
                children: <Widget>[
                  ...
                  Expanded(
                    child: Text(
                      'Enter Instagram username for Post analysis of the user..',
                      maxLines: 3,
              ...
              Row(
                ...
                children: <Widget>[
                  EmojiContainer(
                      icon: EmojiIcon.emo_angry, color: Colors.pinkAccent),
                  EmojiContainer(
              ...
              Text(
                'Depending on the number of posts it may take a while to analyse posts..',
                maxLines: 3,
